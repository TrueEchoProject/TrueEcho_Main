...
const styles = StyleSheet.create({
    ...
    username: {
        ...
        marginTop: Dimensions.get('window').height * 0.015, // 위쪽 여백을 화면 높이의 0.5%로 설정
        alignSelf: 'flex-end', // 자식 요소를 오른쪽 정렬
    },
    date: {
        fontSize: Dimensions.get('window').width * 0.03, // 글자 크기를 화면 너비의 3%로 설정
        fontWeight: "300", // 글자 굵기 300
        color: 'white', // 글자 색상 흰색
        marginTop: 0, // 위쪽 여백 0단위
    ...
    title: {
        ...
        marginBottom: Dimensions.get('window').height * 0.005, // 아래쪽 여백을 화면 높이의 0.5%로 설정
        fontSize: Dimensions.get('window').width * 0.04, // 글자 크기를 화면 너비의 4%로 설정
        marginTop: Dimensions.get('window').height * 0.007, // 위쪽 여백을 화면 높이의 0.7%로 설정
    },
    freeText: {
        color: "white", // 글자 색상 흰색
