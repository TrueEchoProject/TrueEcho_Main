    ...
    const UnderCommentItem = ({ underComment }) => {
        ...
        return (
            <View style={styles.underCommentItem}>
                ...
                <Text style={styles.commentDate}>{formatDate(underComment.createdAt)}</Text>
                {underComment.mine && (
                        ...
                        <Animated.View style={[styles.modalView, { marginTop: animatedHeight }]}>
                            ...
                            <View style={styles.inputContainer}>
                                <TextInput
									...
									placeholderTextColor="#a3a3a3" // 플레이스홀더 텍스트 색상 회색으로 변경
                                />
